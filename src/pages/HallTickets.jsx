      ...
      try {
        ...
        const combined = filtered.map((reg) => {
          ...
          return {
            ...
            hallTicket: student?.hall_ticket_no ?? "â€”",
            group: reg.group_name || reg.group_code || "â€”",
            course: reg.course_name || reg.course_code || "â€”",
            semester: reg.semester ?? "â€”",
            status: reg.status ?? "â€”",
            email: student?.email ?? "",
              ...
              <div className="card-body">
                <div className="row g-3">
                  <div className="col-md-4">
                    ...
                    >
                      <option value="">
                        {loadingOptions ? "Loading examsâ€¦" : "Select Exam"}
                      </option>
                      {!loadingOptions &&
                  ...
                  <div className="col-md-4">
                    ...
                    >
                      <option value="">
                        {loadingOptions ? "Loading groupsâ€¦" : "Select Group"}
                      </option>
                      {!loadingOptions &&
                  ...
                  <div className="col-md-4">
                    ...
                    >
                      <option value="">
                        {loadingOptions ? "Loading coursesâ€¦" : "Select Course"}
                      </option>
                ...
                <div className="card-body">
                  <div className="d-flex justify-content-between align-items-center gap-3 mb-3 flex-wrap">
                    ...
                    {loadingRegistrations && (
                      <span className="text-muted small">Loading studentsâ€¦</span>
                    )}
                  </div>
                  {registrationsError && (
