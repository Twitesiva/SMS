          ...
          <div className="card card-soft p-3 p-md-4">
            <div className="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-3">
              <div className="d-flex align-items-center gap-2">
                ...
                <div><h3 className="fw-bold mb-0 fs-4 fs-md-3">Vijayam College of Arts & Science</h3><div className="text-muted">Chennai</div></div>
              </div>
              <Link to="/admission" className="btn btn-brand btn-sm">Back to Home</Link>
            </div>
