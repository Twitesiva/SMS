  ...
  return (
    ...
    >
      <style>{`
        ...
        .tt-head-title { display: block; fontSize: 0.8rem; fontWeight: 600; }
        .tt-head-time { display: block; fontSize: 0.7rem; color: #6b7280; marginTop: 4px; }
        .tt-day { background: #f8fafc; fontWeight: 600; width: 130px; }
        .tt-period { width: auto; }
        .tt-select { width: 100%; min-height: 38px; height: auto; padding: 6px 12px; fontSize: 0.9rem; lineHeight: 1.2; white-space: normal; overflow: visible; }
        .tt-break, .tt-lunch { width: 34px; min-width: 34px; padding: 0; text-align: center; fontWeight: 800; vertical-align: middle; fontSize: 0.85rem; }
                          ...
                          <td key={slot.key} className="tt-period">
                            ...
                            >
                              ...
                              {subjects.map(s => {
                                ...
                                // Allow if it's the currently selected subject in this exact cell (optimization, though value match handles it visually, 
                                // but we might want to prevent re-selecting if they change mind).
                                // Actually, if it's selected, we should show it.
                                // But <select> logic: if 'value' matches, it's shown.
