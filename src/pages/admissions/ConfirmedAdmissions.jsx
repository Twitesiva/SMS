                                        ...
                                        <div className="mb-3 position-relative">
                                            {selectedApp.photo_url ? (
                                                <img
                                                    ...
                                                    style={{ width: '150px', height: '190px', objectFit: 'cover', objectPosition: 'top center' }}
                                                />
                                            ) : (
                                                <div className="bg-white rounded shadow-sm border border-4 border-white d-flex align-items-center justify-content-center" style={{ width: '150px', height: '190px' }}>
